...
export async function Header({ isLivePreview }: { isLivePreview: boolean }) {
  ...
  return (
    <header className="top-0 before:bottom-1/2 left-0 z-20 before:-z-10 fixed before:absolute before:-inset-5 before:bg-linear-to-b before:from-body before:via-50% before:via-body/80 before:to-body/0 w-full clamp-[py,5,6]">
